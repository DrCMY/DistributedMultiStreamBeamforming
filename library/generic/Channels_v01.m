...
function [J,HppM,G,U,F,V,V1,V2,loaders]=Channels_v01(K,R,M,N,B,d,loaders,PlTxRx,fi1,fi2,fi3,fi4,fi5,fi6)
KM=K*M;
RN=R*N;
...
HppM=dlmread(fi2,'\t',[loaders(2) 0 loaders(2)+RN-1 KM-1]);     % Channels between the transmitters and relays. See \mathbf{H}^{\prime\prime}_{ri} in (2)
