function AI_v05(MonteCarlo,MonteCarloT,K,M,N,d,R,B,PdBTxRx,PdBRRx,sigma2k1,sigma2k2,sigma2r,LPPdB,iterlimit,rhoF,rhocF,rhoU,rhocU,Delta,PDelta,Name1,Name2,faultlimit,wmin,wstep,wmax,InputFolder)
tgGlobal=tic;
