function [fi1,fi2,fi3,fi4,fi5,fi6,fido1,fido2,fido2E,fido3,fido3E,fido4,fido5,fido5E,fido6,fido6E,fido7,fido7E,fido11,fido11E,fido14,fido14E,Name]=IOFiles_v02(Name1,Name2,cverSubFile_b)
% Input files
...
fido11 = fopen(fo11,'w'); fido11E = fopen(fo11E,'w'); fido14 = fopen(fo14,'w'); fido14E = fopen(fo14E,'w'); 