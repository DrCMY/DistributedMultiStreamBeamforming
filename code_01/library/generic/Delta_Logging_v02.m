function [Deltax,iter,counter,checkwhilei,missed,fault,DeltaLogs,AverageDeltaLogs]=Delta_Logging_v02(K,sinr,sinrt,Delta,DeltaLogs,AverageDeltaLogs,counter,iter,steprange,missed,fault,faultlimit,iterlimit,wmin,mc,fido6,fido8)
