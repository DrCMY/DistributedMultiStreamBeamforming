function ExplanatoryFiles_UFIterII_v01(fido2E,fido3E,fido5E,fido6E,fido7E,fido11E,fido14E,fido1,Name2,Delta,iterlimit,rhoF,rhocF,rhoU,rhocU,faultlimit,wmin,wstep,wmax)

%_iter_iterav_PTot_PTotav_
fprintf(fido1,'%%%%%%%%%%\n');fprintf(fido1,'%%Parameters\n');
fprintf(fido1, 'SNR= %s\n', Name2);
fprintf(fido1,'Delta= %1.6f, iterlimit= %d, rhoF= %2.2f, rhocF= %1.2f, rhoU= %2.2f, rhocU= %1.2f, faultmax=%d, wmin=%d, wstep=%d, wmax=%d\n',Delta,iterlimit,rhoF,rhocF,rhoU,rhocU,faultlimit,wmin,wstep,wmax);
...
%_ChannelsDetails_
fprintf(fido11E,'This file gives detailed information about each Monte Carlo run\n');
fprintf(fido11E,'<l: slow convergence>\n');
fprintf(fido11E,'<n: non-convergence (can be due to fluctuation or infeasibility)>\n');
fprintf(fido11E,'<s: success>\n');
fprintf(fido11E,'<U: maximum transmit filter power violation>\n');
fprintf(fido11E,'<F: maximum relay filter power violation>\n');

%_PowerViol_
fprintf(fido14E,'In case, there is a power violation at the transmitter or relay side, this file gives detailed information about these cases\n');
fprintf(fido14E,'<Monte Carlo number>\n');
fprintf(fido14E,'<U: Transmitter side power violation. F: Relay side power violation >\n');
fprintf(fido14E,'<Upper bounds>\n');
fprintf(fido14E,'<Lower bounds>\n');
fprintf(fido14E,'<SINR targets>\n');
fprintf(fido14E,'<Total transmitter power>\n');
fprintf(fido14E,'<Total relay power>\n');
fprintf(fido14E,'<iteration number>\n');